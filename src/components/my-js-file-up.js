...
passwordRepeatElement = document.getElementById('password-repeat');
agreeElement = document.getElementById('agree');
commomErrorElement = document.getElementById('common-error');


document.getElementById('process-button-sing-up').addEventListener('click', validateForm);
...
function validateForm() {
    ...
    if (nameElement.value && nameElement.value.match(/^[А-Я][а-яё]+\s[А-Я][а-яё]+/)) {
