export class MyEditExpense {
    constructor() {
        this.elementId = sessionStorage.getItem('outcomeId');
        console.log(this.elementId);
        this.elementName = sessionStorage.getItem('outcomeItem');
    ...
    async edit() {
        // alert("sessionStorage.getItem('outcomeId') + '  ' + sessionStorage.getItem('outcomeItem')");
        ...
        try {
            ...
            const response = await fetch('http://localhost:3000/api/categories/expense/' + this.elementId, {
                method: 'PUT',
                headers: {
